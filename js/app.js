(() => {
    ...
    function initSliders() {
        if (document.querySelector(".info__slider")) new Swiper(".info__slider", {
        ...
        resizableSwiper("(max-width: 549.98px)", ".interested__slider", {
        ...
        if (document.querySelector(".payment-delivery__slider")) new Swiper(".payment-delivery__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    addActiveClass(".menu__toggle", "open-dropdown");
    addActiveClass(".languages__current", "open-languages");
    addActiveClass(".process__more", "open-text");
    if (document.querySelector(".footer__btn-top")) {
        const scrollToTopButton = document.querySelector(".footer__btn-top");
